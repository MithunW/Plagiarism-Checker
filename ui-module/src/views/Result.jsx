...
class Dashboard extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
        ...
        plagiarism: this.props.location.state.plagiarism,
        unique: 100-this.props.location.state.plagiarism,
    }
  }
  ...
  render() {
    ...
    const Highlighted = ({text = '', highlight = ''}) => {
      ...
      return <span style={{fontSize:'20px'}}> { parts.map((part, i) => 
          <span key={i} style={part.toLowerCase() === highlight.toLowerCase() ? { fontWeight: 'bold',backgroundColor:'#FADBD8',color:'#943126' } : {} }>
              { part }
          </span>)
      } </span>;
    }
                ...
                <CardBody >
                  ...
                  <Row style={{textAlign:'right'}} >
                   <Grid container style={{ margin:'3rem' }}>
                      ...
                      <Grid item xs={9} sm={4}>
                          <Typography style={{fontSize:'23px', fontWeight:'600', margin:'2rem 0 0 -10rem'}}>
                            {progress}% Checked
                          </Typography>
                      </Grid> */}
                        ...
                        <Grid container>
                          <Grid item xs={3} sm={2}>
                            <div style={{width:'5.5rem'}}>
                              <CircularProgressbar value={this.state.plagiarism} text={`${this.state.plagiarism}%`} 
                                styles={buildStyles({
                                  rotation: 0,
                                  strokeLinecap: 'butt',
                                  textSize: '20px',
                          ...
                          <Grid item xs={9} sm={4}>
                          <Typography style={{fontSize:'23px', fontWeight:'600', margin:'1.8rem 0 0 0', display: 'inline-block'}}>
                      ...
                      <Grid item xs={12} sm={6} >
                        <Grid container>
                          <Grid item xs={3} sm={2}>
                            <div style={{width:'5.5rem'}}>
                              <CircularProgressbar value={this.state.unique} text={`${this.state.unique}%`} 
                                styles={buildStyles({
                                  rotation: 0,
                                  strokeLinecap: 'butt',
                                  textSize: '20px',
                          ...
                          <Grid item xs={9} sm={4}>
                            <Typography style={{fontSize:'23px', fontWeight:'600', margin:'1.8rem 2rem 0 0'}}>
                    ...
                    <Col>
                       <AppBar position="static" color="default">
                          <Tabs
                            ...
                            centered
                          >
                            <Tab label="Sentence Wise Result" icon={<DescriptionIcon style={{fontSize:'50px'}} />} {...a11yProps(0)} />
                            <Tab label="Match Sources" icon={<FileCopyIcon  style={{fontSize:'50px'}} />} {...a11yProps(1)} />
                            <Tab label="Document View" icon={<FindInPageIcon  style={{fontSize:'50px'}} />} {...a11yProps(2)} />
                            ...
                            <div key={key}>
                              <Grid container>
                                ...
                                <Grid item xs={2} sm={1} style={{margin:'0.3rem 0 0.3rem -3rem'}}> 
                                  <Button
                                    style={{color:'#943126', display:data[1]<0.8?'none':''}}
                                    startIcon={<ForwardIcon style={{ fontSize:'40px'}} />}
                                  >
                                    compare
                                  </Button>
                                </Grid>
                              ...
                              {this.state.result.map((data, key) => (
                                <div key={key}>
                                  <Grid container style={{display:data[1]<0.8?'none':''}}>
                                    <Grid item xs={8} sm={8} style={{margin:'0.3rem 0 0.3rem 0', textAlign:'left'}}> 
                                      <Typography style={{backgroundColor:'#F2F3F4', textAlign:'left', fontSize:'20px', fontWeight:600, textAlign:'center', padding:'0.9rem 0 0.9rem 0'}} >
                                        <a style={{color:'#2C3E50'}} href={data[2]} target="_blank">{data[2]}</a>
                                      </Typography>   
                                    </Grid>
                                    <Grid item xs={4} sm={4} style={{margin:'0.3rem 0 0.3rem 0'}}> 
                      ...
                      <Grid container >
                        ...
                        <Grid item xs={4}>
                          <Button
                            ...
                            style={{backgroundColor:'#1F618D', padding:'0.5rem 3rem 0.5rem 3rem'}}
                            // onClick={this.onSubmit}
                            >
                              New Search
                          </Button> 
