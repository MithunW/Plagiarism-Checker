...
class SignUp extends React.Component {
  ...
  const classes  ={
      ...
      main:{
        // position: 'relative',
        // backgroundImage: 'url(' + require('../assets/img/plagiarism-check5.jpg') + ')',
        // backgroundColor:'red',
    ...
    return(
      ...
      // <CardContent>
        ...
        <img style={classes.img} src={require("../assets/img/unique.jpg")} height='100%' width='100%'/>
          ...
          <Grid item xs={12} sm={6}>
          <Container component="main"  style={{itemAlign:'center',right:'0',backgroundColor:'#F0F3F0 '}}>
          {/* <CssBaseline /> */}
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={6} sm={6} style={{textAlign:'right'}}>
                  <Button
                    ...
                    variant="contained"
                    color="secondary"
                    style={{margin:'3rem 0 0 0', padding:'0.5rem 2rem', fontSize:'20px',}}
                  >
                    Cancle
                  </Button>
                </Grid>
